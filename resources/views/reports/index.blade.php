...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form  action="/Search_Invoice" method="get" enctype="multipart/form-data" autocomplete="off">
                        {{ csrf_field() }}
                        {{-- 1 --}}
                        <div class="col-lg-3">
                            <label class="rdiobox">
                                <input checked name="rdio" type="radio" value="1" id="type_div"> <span>Search With Invoice Type
                                </span></label>
                        </div>


                        <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                            <label class="rdiobox"><input name="rdio" value="2" type="radio"><span>Search With Invoice Number
                            </span></label>
                        </div><br><br>

                        {{-- 2 --}}
                        <div class="row">
                            <div class="col" id="invoice_type">
                                <label for="inputName" class="control-label">Select invoice type</label>
                                <select name="invoice_type" class="form-control SlectBox" >
                                    <!--placeholder-->
                                    <option value="" selected disabled></option>

                                        <option value="paid">Paid Invoices</option>
                                    <option value="not paid"> Unpaid Invoices</option>
                                    <option value="Partialy Paid">Partialy Paid Invoices</option>
